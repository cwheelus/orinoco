...
| 🗄️ Data            | Open Data page (filters, point sizing, point opacity)                                                                      |
...
- The **Isolate icon** in the icon strip lights up, so you know a filter is active even with the panel closed
