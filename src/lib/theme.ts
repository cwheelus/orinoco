...
export const PANEL = {
  ...
  divider: "bg-white/10 light:bg-black/10",
};

export const TEXT = {
  // Section headings (Data / Grid / Isolate).
  heading: "text-[10px] font-bold text-blue-400 light:text-blue-600 uppercase",
  // Primary body/label text — the most common weight, used for most
  // labels throughout the panel (e.g. "Filters", "Tick labels", axis
  // checkbox labels).
  body: "text-white/70 light:text-black/70",
  // Small uppercase section sub-labels (e.g. "Classes", "Value").
  subtle:
    "text-[9px] uppercase tracking-wide text-white/40 light:text-black/40",
  ...
  muted: "text-white/50 light:text-black/50",
  ...
  faint: "text-white/45 light:text-black/45",
  ...
  emphasis: "text-white/80 light:text-black/80",
  // Fully opaque, high-contrast text for content sitting on a
  // distinct filled surface: the Point Analysis panel's UID/metric
  // values (on SURFACE.card) and the bottom control guide's key-group
  // labels. DOES need a light: variant — SURFACE.card and the control
  // guide both flip to light backgrounds in light mode, so plain white
  // text would become nearly invisible there without an override.
  onFilled: "text-white light:text-black",
  ...
  iconDefault: "text-white/60 light:text-black/60",
};

export const LINK = {
  // Clickable inline text actions (Clear filters, Reset isolation).
  base: "text-blue-400 hover:text-blue-300 light:text-blue-600 light:hover:text-blue-700 transition-colors",
};

export const INPUT = {
  // Text inputs, selects, number fields.
  base: "bg-white/10 text-white outline-none focus:bg-white/20 light:bg-black/5 light:text-black light:focus:bg-black/10",
  ...
  optionBg: "bg-slate-800 light:bg-white",
};
...
export const HOVER = {
  ...
  subtle: "hover:bg-white/5 light:hover:bg-black/5",
};

export const ICON_BUTTON = {
  // Applied when a toggle/page icon is the active/selected one.
  active: "bg-blue-500/40 text-white light:bg-blue-500/20 light:text-blue-900",
  // Applied otherwise — dim by default, brightens on hover.
  idle: "text-white/50 hover:bg-white/10 hover:text-white light:text-black/50 light:hover:bg-black/5 light:hover:text-black",
};
...
export const SURFACE = {
  ...
  root: "bg-slate-900 light:bg-slate-50",
  ...
  // opaque window.
  card: "bg-slate-900/80 backdrop-blur-md light:bg-white/85",
};

export const PANEL_APP = {
  // The bottom-left keyboard control-guide box.
  controlGuide:
    "bg-white/5 backdrop-blur-sm border border-white/10 rounded light:bg-black/5 light:border-black/10",
  // The bottom-right classification color-legend box.
  legend:
    "bg-black/60 ring-1 ring-white/10 rounded light:bg-white/70 light:ring-black/10",
  ...
  hairline: "border-white/5 light:border-black/5",
};

export const ERROR = {
  // The CSV-load error/info banner.
  bg: "bg-red-950/80 backdrop-blur-md border-l-2 border-red-500 ring-1 ring-white/10 shadow-2xl light:bg-red-50 light:ring-black/10",
...
export const KBD = {
  ...
  base: "px-2 py-0.5 bg-white/20 rounded text-xs font-bold font-mono light:bg-black/10",
};
